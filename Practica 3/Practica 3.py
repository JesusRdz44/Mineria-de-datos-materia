...
plot_histograma(df, "Weight", bins=30,titulo="Distribución del peso levantado (Weight)",archivo="histograma_weight.png",)
top5_ejercicios = df["Exercise Name"].value_counts().head(5).index.tolist()
plot_boxplot(df, "Weight", agrupar_por="Exercise Name", categorias=top5_ejercicios,titulo="Distribución de peso por ejercicio (Top 5 más frecuentes)",archivo="weight_por_ejercicio.png",)
plot_dispersion(df, "Weight", "Reps",titulo="Relación entre peso (Weight) y repeticiones (Reps)",archivo="dispersion_weight_reps.png",)
plot_pastel(df, "Workout Name", top_n=6,titulo="Proporción de series por tipo de rutina (Top 6 + Otros)",archivo="pastel_workout_name.png",)
plot_barras(df, "Exercise Name", top_n=10,titulo="Top 10 ejercicios más registrados",archivo="barras_top_ejercicios.png",)
